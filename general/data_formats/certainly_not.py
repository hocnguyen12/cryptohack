...
"""
<nguyenvh ~/Sync/cryptohack/general/data_formats [21:02]> openssl x509 -inform DER -in 2048b-rsa-example-cert_3220bd92e30015fe4fbeb84a755e7ca5.der -outform PEM -text -noout
Certificate:
    Data:
        Version: 1 (0x0)
